...
import com.formation.pokemonapp.exception.model.*;
import com.formation.pokemonapp.entity.HttpResponse;
...
import com.formation.pokemonapp.utility.JWTTokenProvider;
...
import static com.formation.pokemonapp.constant.SecurityConstant.JWT_TOKEN_HEADER;
...
public class UserController extends ExceptionHandling {
    ...
    public ResponseEntity<User>  register(@Valid @RequestBody User user) throws UserNotFoundException, EmailExistException, UserNameExistException, MessagingException {
    ...
    public byte[] getProfileImage(@RequestParam("username") String username, @PathVariable("fileName") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(USER_FOLDER + username + FORWARD_SLASH + fileName));
    }

    @GetMapping(path = "/image/{profile}/{username}", produces = IMAGE_JPEG_VALUE)
    public byte[] getTempProfileImage(@RequestParam("username") String username) throws IOException {
